        ...
        <div className="mt-16 sm:mt-20 lg:mt-24 scroll-animate fade-up" data-delay="3">
          <div className="bg-[#0C1628] rounded-2xl sm:rounded-3xl px-6 py-8 sm:px-8 sm:py-12 md:px-12 md:py-16 lg:px-16 lg:py-20 text-center">
            ...
            <div className="flex flex-col items-center justify-center">
              <Link href="https://app.remontaservices.com.au/registration/clients" className="inline-flex items-center justify-center gap-2 rounded-full bg-[#B1C3CD] px-6 py-3 sm:px-8 sm:py-4 font-sans font-semibold text-sm sm:text-base text-[#0C1628] hover:bg-white transition-colors duration-200 w-full sm:w-auto max-w-md">
