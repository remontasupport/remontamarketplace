 ...
 *
 * Wraps all worker dashboard pages (/dashboard/worker/**)
 * Handles authentication at the layout level to protect all child pages
 *
 * SECURITY: This layout ensures ALL worker pages require authentication
...
export default function WorkerLayout({
  ...
  // SECURITY: Require authentication for ALL worker pages
  // This protects all routes under /dashboard/worker/**
