...
export async function POST(request: Request) {
  console.log("🎯 Infection control training upload API called");
  ...
  try {
    ...
    console.log(`✅ Infection control training uploaded to blob:`, blob.url);

    // 6. Check if infection control document already exists
    console.log("🔍 Checking for existing infection control document...");
    ...
    if (existingDoc) {
      ...
      console.log(`🔄 Updating existing infection control document`);
      ...
      console.log(`✨ Creating new infection control document`);
    ...
    console.error("❌ Infection control training upload error:", error);
