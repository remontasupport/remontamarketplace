    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-4xl font-cooper text-gray-900">Worker Dashboard</h1>
        ...
        <Card>
          ...
          <CardContent>
            <p className="font-poppins text-gray-600">
              Your worker dashboard features will be implemented here, including:
            </p>
            <ul className="list-disc list-inside mt-4 space-y-2 font-poppins text-gray-600">
              ...
              <li>Track bookings and schedule</li>
