/**
 * Archived Requests Page for Support Coordinators
 * Shows service requests that have been archived by the coordinator
 */
...
export default async function CoordinatorArchivedPage() {
