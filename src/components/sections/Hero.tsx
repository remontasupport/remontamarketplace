        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
              <Link
                href="/find-support"
                className="inline-flex items-center justify-center rounded-full bg-white border border-[#0C1628] px-6 sm:px-8 py-2.5 sm:py-3 font-sans font-semibold text-sm sm:text-base text-[#0C1628] hover:bg-gray-50 transition-colors duration-200"
              >
                Find support
              </Link>
              <Link
                href="/become-support-worker"
                className="inline-flex items-center justify-center rounded-full bg-[#0C1628] px-6 sm:px-8 py-2.5 sm:py-3 font-sans font-semibold text-sm sm:text-base text-white hover:bg-[#B1C3CD] hover:text-[#0C1628] transition-colors duration-200"
              >
                Provide support
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 mt-1">
                  <div className="w-9 h-9 bg-[#F8E8D8] rounded-full flex items-center justify-center">
                    <svg className="w-5 h-5 text-[#0C1628]" stroke="currentColor" fill="none" viewBox="0 0 64 64" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="flex-1">
                  <div className="font-sans font-bold text-base sm:text-lg text-[#0C1628] leading-tight">99%</div>
                  <div className="font-sans text-xs sm:text-sm text-gray-600 leading-tight">Job completion rate with verified workers.</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="font-sans font-bold text-base sm:text-lg text-[#0C1628] leading-tight">610,000+</div>
                  <div className="font-sans text-xs sm:text-sm text-gray-600 leading-tight">Australian supported by the NDIS</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="font-sans font-bold text-base sm:text-lg text-[#0C1628] leading-tight">70%</div>
                  <div className="font-sans text-xs sm:text-sm text-gray-600 leading-tight">Admin time saved.</div>
                </div>
              </div>
            </div>
          </div>
